...
- Verificación local: comprueba qué versión de cada especificación exige el anexo técnico vigente en tu jurisdicción; los perfiles se actualizan y los identificadores de RFC cambian al obsoletarse. **Fecha de verificación de esta clase: 2026-09-22.**
