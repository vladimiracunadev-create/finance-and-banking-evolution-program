...
- Comisión para el Mercado Financiero. *Normativa del Sistema de Finanzas Abiertas: consentimiento, vigencia y revocación*. CMF. <https://www.cmfchile.cl/>
- European Data Protection Board (2020). *Guidelines 05/2020 on consent under Regulation 2016/679*. EDPB. <https://www.edpb.europa.eu/our-work-tools/our-documents/guidelines/guidelines-052020-consent-under-regulation-2016679_en>
- OpenID Foundation. *FAPI 2.0 — Grant Management for OAuth 2.0*. <https://openid.net/wg/fapi/>
- Bank for International Settlements (2021). *Data governance and consent in open finance*. BIS. <https://www.bis.org/publ/bppdf/bispap117.htm>
- Biblioteca del Congreso Nacional de Chile. *Ley N.º 19.628 sobre protección de la vida privada y su normativa sucesora en materia de datos personales*. <https://www.bcn.cl/leychile>
- Verificación local: comprueba el plazo máximo de vigencia y los requisitos de revocación exigidos por la norma vigente en tu jurisdicción. **Fecha de verificación de esta clase: 2026-08-06.** Esta clase no constituye asesoría legal.
