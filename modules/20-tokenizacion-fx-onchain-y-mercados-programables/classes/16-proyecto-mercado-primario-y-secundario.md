...
- Verificación local: comprueba qué autorizaciones exige tu jurisdicción para operar una infraestructura de este tipo y si existe un régimen piloto o de exención aplicable. Esta clase no constituye asesoría legal. **Fecha de verificación de esta clase: 2026-09-22.**
