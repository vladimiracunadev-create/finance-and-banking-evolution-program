...
- Verificación local: comprueba si el instrumento está calificado como valor en tu jurisdicción, qué régimen de custodia le aplica y si admite cuentas segregadas en un registro distribuido. Esta clase no constituye asesoría legal. **Fecha de verificación de esta clase: 2026-09-22.**
