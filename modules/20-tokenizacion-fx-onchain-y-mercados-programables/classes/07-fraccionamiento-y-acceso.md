...
- Verificación local: comprueba qué obligaciones de idoneidad y qué límites de comercialización a minoristas impone tu jurisdicción para este tipo de activo. Esta clase no constituye asesoría legal ni recomendación de inversión. **Fecha de verificación de esta clase: 2026-09-22.**
