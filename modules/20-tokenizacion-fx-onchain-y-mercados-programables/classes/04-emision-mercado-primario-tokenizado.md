...
- Verificación local: comprueba qué constituye oferta pública en tu jurisdicción, qué exenciones existen y qué información mínima exige el folleto para este tipo de instrumento. Esta clase no constituye asesoría legal. **Fecha de verificación de esta clase: 2026-09-22.**
