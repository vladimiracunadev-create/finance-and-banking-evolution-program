...
- Comisión para el Mercado Financiero. *Normativa sobre autorización de entidades y planes de negocio*. CMF. <https://www.cmfchile.cl/portal/principal/613/w3-channel.html>
- Verificación local: comprueba qué exige tu jurisdicción en un plan de negocio para autorización y qué actividades puede ejercer una misma entidad. Esta clase no constituye asesoría legal. **Fecha de verificación de esta clase: 2026-08-06.**
