...
part: 22
class: 20
title: "El Salvador: bitcoin, Chivo y activos digitales"
level: profesional
duration_minutes: 90
status: complete
jurisdictions: [el-salvador, internacional]
regulatory_topics: [curso-legal, adopcion, remesas, activos-digitales, evaluacion-de-politica]
regulation_last_verified: 2026-08-12
regulatory_status: vigente con reformas
primary_authorities: [CNAD, Banco Central de Reserva de El Salvador, FMI]
...
> [← 19 · Regímenes europeos conexos: piloto DLT, DORA y regla del viaje](19-regimenes-europeos-conexos.md) · [Índice de la parte](../README.md) · [21 · Espacios de prueba y regulación experimental →](21-espacios-de-prueba-y-regulacion-experimental.md)
...
- Asamblea Legislativa de la República de El Salvador. *Ley Bitcoin y sus reformas*. <https://www.asamblea.gob.sv/>
...
|---|---|---|
| [← 19 · Regímenes europeos conexos: piloto DLT, DORA y regla del viaje](19-regimenes-europeos-conexos.md) | [Parte 22](../README.md) · [Programa](../../../SYLLABUS.md) | [21 · Espacios de prueba y regulación experimental →](21-espacios-de-prueba-y-regulacion-experimental.md) |
<!-- gen:footer:end -->
