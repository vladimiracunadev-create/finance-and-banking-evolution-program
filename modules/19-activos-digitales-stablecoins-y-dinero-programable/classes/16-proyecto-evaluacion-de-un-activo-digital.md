...
part: 20
class: 16
title: "Proyecto: evaluación de un activo digital"
level: profesional
duration_minutes: 90
status: complete
jurisdictions: [chile, internacional]
regulatory_topics: [gobierno-corporativo, gestion-de-riesgos, due-diligence]
...
<!-- gen:header:start -->
# Clase 16 · Proyecto: evaluación de un activo digital

> [← 15 · Contabilidad, tributación y balance](15-contabilidad-tributacion-y-balance.md) · [Índice de la parte](../README.md) · [Proyecto de la parte →](../project/README.md)
...
- Comisión para el Mercado Financiero. *Normativa sobre gestión de riesgos y gobierno corporativo*. CMF. <https://www.cmfchile.cl/portal/principal/613/w3-channel.html>
- Verificación local: comprueba qué exige tu supervisor para aprobar una exposición a activos digitales, qué información debe constar en el acta y con qué periodicidad se revisa. Esta clase no constituye asesoría legal. **Fecha de verificación de esta clase: 2026-08-06.**
...
|---|---|---|
| [← 15 · Contabilidad, tributación y balance](15-contabilidad-tributacion-y-balance.md) | [Parte 20](../README.md) · [Programa](../../../SYLLABUS.md) | [Proyecto de la parte →](../project/README.md) |
<!-- gen:footer:end -->
