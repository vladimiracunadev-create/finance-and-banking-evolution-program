...
- OCDE (2021). *Recommendation of the Council on Financial Literacy*. OECD. <https://legalinstruments.oecd.org/en/instruments/OECD-LEGAL-0461>
...
- Verificación local: comprueba qué límites impone tu jurisdicción a la restricción de uso del dinero, a la caducidad de saldos y al tratamiento automatizado de decisiones que afectan a personas. Esta clase no constituye asesoría legal. **Fecha de verificación de esta clase: 2026-08-06.**
