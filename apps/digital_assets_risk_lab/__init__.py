...
Nueve modulos, cada uno asociado a una afirmacion concreta de una clase:
    ...
    redemption      el orden de la cola crea la corrida
    depeg           el detonante no se repite; el mecanismo si
    algorithmic     el ratio de absorcion sube mientras el sistema cae
